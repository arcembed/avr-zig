...
pub fn build(b: *std.Build) void {
    ...
    avr_board.addUploadStep(b, board, upload_profile, tty, "Flash the pwm-fade example with avrdude", bin_path);
    avr_board.addObjdumpStep(b, "Disassemble the pwm-fade firmware", bin_path);
}
