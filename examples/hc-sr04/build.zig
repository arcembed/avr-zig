...
pub fn build(b: *std.Build) void {
    ...
    avr_board.addUploadStep(b, board, tty, "Flash the HC-SR04 example with avrdude", bin_path);
    avr_board.addObjdumpStep(b, "Disassemble the HC-SR04 firmware", bin_path);
