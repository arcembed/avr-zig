...
pub fn build(b: *std.Build) void {
    ...
    avr_board.addUploadStep(b, board, tty, "Flash the SSD1306 example with avrdude", bin_path);
    avr_board.addObjdumpStep(b, "Disassemble the SSD1306 demo firmware", bin_path);
