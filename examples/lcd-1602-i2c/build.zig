...
pub fn build(b: *std.Build) void {
    ...
    avr_board.addUploadStep(b, board, tty, "Flash the LCD 1602 I2C example with avrdude", bin_path);
    avr_board.addObjdumpStep(b, "Disassemble the LCD 1602 I2C firmware", bin_path);
