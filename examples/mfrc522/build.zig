...
pub fn build(b: *std.Build) void {
    ...
    avr_board.addUploadStep(b, board, tty, "Flash the mfrc522 example with avrdude", bin_path);
    avr_board.addObjdumpStep(b, "Disassemble the mfrc522 firmware", bin_path);
