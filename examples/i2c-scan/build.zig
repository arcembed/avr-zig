...
pub fn build(b: *std.Build) void {
    ...
    avr_board.addUploadStep(b, board, tty, "Flash the I2C scan example with avrdude", bin_path);
    avr_board.addObjdumpStep(b, "Disassemble the I2C scan firmware", bin_path);
